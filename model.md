...
> Configuration layer reference for A2v10 — the model.json file that wires endpoints to SQL and XAML. Actions, dialogs, popups, commands, reports, and file upload.

- [model.json Overview](https://docs-llm.a2v10.com/model/overview.md): Top-level structure, inheritance rules, and endpoint configuration
- [Actions](https://docs-llm.a2v10.com/model/actions.md): Configuring page actions — view loading, stored procedure mapping, merge, and export
