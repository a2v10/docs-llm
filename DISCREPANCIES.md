...
|---|---|---|
| Реализация | `C:\A2v10_Net6` (Core, актуальная), `C:\A2v10_Net48` | Разрешает спор о факте, но **источником контента не является**: в `.md` из кода не переносится ничего — что публиковать, решает Александр (2026-08-23) |
...
| Укр. справка | `C:\A2v10_Net48\A2v10.Uk.Help\A2v10.Help\html\` | Отстаёт от реализации, но именно по ней пишется docs-llm. Единственный источник контента |
...
### D4. `CLAUDE.md` разошёлся с репозиторием — ЗАКРЫТО 2026-08-23

- «The root `llms.txt` ... only **three** entries» — исправлено на шесть.
- В дереве Content Structure не хватало `xaml/layouts/sheet.md`, `app/`, `xaml/text.md`
  и части controls — дописано.

### D6. `Text.Size` — ЗАКРЫТО 2026-08-23

В `xaml/text/text.html` значения `TextSize` были переставлены местами
